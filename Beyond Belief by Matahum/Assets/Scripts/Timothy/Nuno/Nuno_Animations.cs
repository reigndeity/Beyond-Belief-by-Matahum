...
public class Nuno_Animations : MonoBehaviour
{
    private Animator animator;
    private Nuno_AttackManager atkMngr;
    private string currentAnimationState = "Nuno_Idle";
    public bool isHit = false;

    private void Start()
    {
        animator = GetComponent<Animator>();
        atkMngr = GetComponent<Nuno_AttackManager>();
    }
    ...
    {
        isHit = true;
        int hitIndex = Random.Range(1, 3);
        string hitAnim = $"Nuno_GetHit_{hitIndex}";
